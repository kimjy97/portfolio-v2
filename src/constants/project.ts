...
export const projectData: IProjectProps[] = [{
  ...
  learned: ' **React**와 **React Native**의 차이점을 깊이 이해하게 되었고, 모바일 환경에서의 성능 최적화와 네이티브 모듈 사용 방법을 배웠습니다. 특히, 카메라 모듈을 활용한 이미지 처리와 앱 출시 과정에 대한 경험을 쌓으며, Google Play 등록 절차와 팀 프로젝트에서의 협업 중요성을 체감했습니다. 또한, 다양한 디바이스에서의 동작을 고려한 반응형 UI와 성능 최적화 방법을 익히며 실무 역량을 강화했습니다.',
